...
from datasets.CoeffAxis3DDIMArrayDataset import CoeffAxis3DDIMArrayDataset
                ...
                try:
                    for checkpoint in checkpoints:
                        ...
                        for guidance_scale in guidance_scales:
                            ...
                            output_dir = f"output/{FOLDER_NAME}/val_coeff3_{mode}/{METHODS[version]}/{guidance_scale}/{NAMES[version]}/{LRS[version]}/chk{checkpoint}/"
