...
from sddiffusionface import SDDiffusionFace, ScrathSDDiffusionFace
...
parser.add_argument(
    ...
    '--network_type', 
    type=str,
    choices=['sd','scrath'],  # Restrict the input to the accepted strings
...
def main():
    ...
    train_dataset = DiffusionFaceRelightDataset(root_dir=train_dir, dataset_multiplier=1,specific_prompt=specific_prompt)
