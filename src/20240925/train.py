...
def main():
    ...
    if args.dataset_val_split.endswith('array.json'):
        val_dataset = DDIMArrayEnvDataset(root_dir=val_dir, index_file=args.dataset_val_split)
    else:
        val_dataset = DDIMDataset(root_dir=val_dir, index_file=args.dataset_val_split)
