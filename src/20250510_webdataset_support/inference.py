...
# NOTE multi_illumination_(least_square/real)_diffusionlight_1e-5 use v2 checkpoint 
# NOTE multi_illumination_(least_square/real)_diffusionlight_1e-5 use v3 checkpoint  due to incorrected save
PRESET = {
    '1e-4': [],
    '1e-5': [],
    '1e-4_normalize32':[],
    ...
    '1e-4b32': [
        {
            ...
            'path': f"/ist/ist-share/vision/pakkapon/relight/sd-light-time/output_t1/20250510_webdataset_support/controlnet/shading_webdataset_batch32/v1/1e-4/checkpoint-13000/controlnet"
        }
    ],
    '1e-5b32': [
        {
            'name': f'checkpoint-13000',
            'path': f"/ist/ist-share/vision/pakkapon/relight/sd-light-time/output_t1/20250510_webdataset_support/controlnet/shading_webdataset_batch32/v1/1e-5/checkpoint-38000/controlnet"
        }
    ],
    '1e-4b32max32': [
        {
    ...
    'multi_illumination_least_square_diffusionlight_1e-4': [
       {
            'name': f'chk80',
        ...
        #  {
        #     'name': f'chk20',
        #     'path': '/ist/ist-share/vision/pakkapon/relight/sd-light-time/output_t1/20250510_webdataset_support/controlnet/multi_illumination_least_square_diffusionlight/v3/1e-4/checkpoint-61580/controlnet',
        # },
    ],
    'multi_illumination_least_square_diffusionlight_1e-5': [
        {
            'name': f'chk60',
        ...
        {
            'name': f'chk40',
            'path': f'/ist/ist-share/vision/pakkapon/relight/sd-light-time/output_t1/20250510_webdataset_support/controlnet/multi_illumination_least_square_diffusionlight/v2/1e-5/checkpoint-61580/controlnet'
        },
    ],
    'multi_illumination_real_diffusionlight_1e-4': [   
        {
            'name': f'chk98',
            'path': f'/ist/ist-share/vision/pakkapon/relight/sd-light-time/output_t1/20250510_webdataset_support/controlnet/multi_illumination_real_diffusionlight/v3/1e-4/checkpoint-301742/controlnet'
        },
        # {
        #     'name': f'chk80',
        #     'path': f'/ist/ist-share/vision/pakkapon/relight/sd-light-time/output_t1/20250510_webdataset_support/controlnet/multi_illumination_real_diffusionlight/v3/1e-4/checkpoint-246320/controlnet'
        # },
        # {
        #     'name': f'chk60',
        #     'path': f'/ist/ist-share/vision/pakkapon/relight/sd-light-time/output_t1/20250510_webdataset_support/controlnet/multi_illumination_real_diffusionlight/v3/1e-4/checkpoint-184740/controlnet'
        # },
        # {
        #     'name': f'chk40',
        #     'path': f'/ist/ist-share/vision/pakkapon/relight/sd-light-time/output_t1/20250510_webdataset_support/controlnet/multi_illumination_real_diffusionlight/v3/1e-4/checkpoint-123160/controlnet'
        # },    
        # {
        #     'name': f'chk20',
        #     'path': f'/ist/ist-share/vision/pakkapon/relight/sd-light-time/output_t1/20250510_webdataset_support/controlnet/multi_illumination_real_diffusionlight/v3/1e-4/checkpoint-61580/controlnet'
        # },
    ],
    'multi_illumination_real_diffusionlight_1e-5': [
        {
            'name': f'chk80',
            'path': f'/ist/ist-share/vision/pakkapon/relight/sd-light-time/output_t1/20250510_webdataset_support/controlnet/multi_illumination_real_diffusionlight/v2/1e-5/checkpoint-246320/controlnet'
        },
        {
            'name': f'chk60',
            'path': f'/ist/ist-share/vision/pakkapon/relight/sd-light-time/output_t1/20250510_webdataset_support/controlnet/multi_illumination_real_diffusionlight/v2/1e-5/checkpoint-184740/controlnet'
        },
        {
            'name': f'chk40',
            'path': f'/ist/ist-share/vision/pakkapon/relight/sd-light-time/output_t1/20250510_webdataset_support/controlnet/multi_illumination_real_diffusionlight/v2/1e-5/checkpoint-123160/controlnet'
        },        
        {
            'name': f'chk50',
            'path': f'/ist/ist-share/vision/pakkapon/relight/sd-light-time/output_t1/20250510_webdataset_support/controlnet/multi_illumination_real_diffusionlight/v2/1e-5/checkpoint-61580/controlnet'
        },
    ],
    'batch_8_v1_r1': [
        {
    ...
    'multilum_real_5k_laion_150k': [
        {
            'name': f'checkpoint-300000',
            'path': f'/ist/ist-share/vision/pakkapon/relight/sd-light-time/output_t1/20250510_webdataset_support/controlnet/multi_illumination_portion/v1/multilum_real_5k_laion_150k/checkpoint-300000/controlnet'
        },
    ],
    'multilum_real_10k_laion_150k': [
        {
            'name': f'checkpoint-300000',
            'path': f'/ist/ist-share/vision/pakkapon/relight/sd-light-time/output_t1/20250510_webdataset_support/controlnet/multi_illumination_portion/v1/multilum_real_10k_laion_150k/checkpoint-300000/controlnet'
        },
    ],
    'multilum_real_25k_laion_25k': [
        {
            'name': f'checkpoint-300000',
            'path': f'/ist/ist-share/vision/pakkapon/relight/sd-light-time/output_t1/20250510_webdataset_support/controlnet/multi_illumination_portion/v1/multilum_real_25k_laion_25k/checkpoint-300000/controlnet'
        },
    ],
    'multilum_real_25k_laion_50k': [
        {
            'name': f'checkpoint-300000',
            'path': f'/ist/ist-share/vision/pakkapon/relight/sd-light-time/output_t1/20250510_webdataset_support/controlnet/multi_illumination_portion/v1/multilum_real_25k_laion_50k/checkpoint-300000/controlnet'
        },
    ],
    'multilum_real_25k_laion_75k': [
        {
            'name': f'checkpoint-300000',
            'path': f'/ist/ist-share/vision/pakkapon/relight/sd-light-time/output_t1/20250510_webdataset_support/controlnet/multi_illumination_portion/v1/multilum_real_25k_laion_75k/checkpoint-300000/controlnet'
        },
    ],
    'multilum_real_25k_laion_100k': [
        {
            'name': f'checkpoint-300000',
            'path': f'/ist/ist-share/vision/pakkapon/relight/sd-light-time/output_t1/20250510_webdataset_support/controlnet/multi_illumination_portion/v1/multilum_real_25k_laion_100k/checkpoint-300000/controlnet'
        },
    ],
    'multilum_real_25k_laion_125k': [
        {
            'name': f'checkpoint-300000',
            'path': f'/ist/ist-share/vision/pakkapon/relight/sd-light-time/output_t1/20250510_webdataset_support/controlnet/multi_illumination_portion/v1/multilum_real_25k_laion_125k/checkpoint-300000/controlnet'
        },
    ],
    'multilum_real_25k_laion_150k': [
        {
            'name': f'checkpoint-300000',
            'path': f'/ist/ist-share/vision/pakkapon/relight/sd-light-time/output_t1/20250510_webdataset_support/controlnet/multi_illumination_portion/v1/multilum_real_25k_laion_150k/checkpoint-300000/controlnet'
        },
    ],
}

# generate from checkpoint with 
# for i in range(140000, 0, -5000):
#     PRESET['1e-4'].append({
#         'name': f'checkpoint-{i}',
#         'path': f"/pure/t1/checkpoints/sd-light-time/20250425_huggingface_controlnet/controlnet/shading_v4/v1/1e-4/checkpoint-{i}/controlnet"
#     })
#     PRESET['1e-5'].append({
#         'name': f'checkpoint-{i}',
#         'path': f"/pure/t1/checkpoints/sd-light-time/20250425_huggingface_controlnet/controlnet/shading_v4/v1/1e-5/checkpoint-{i}/controlnet"
#     })

#for i in range(240000, 100000, -10000):
for i in [500000]:
    PRESET['1e-4'].append({
        'name': f'checkpoint-{i}',
        'path': f"/pure/t1/checkpoints/sd-light-time/20250510_webdataset_support/controlnet/shading_webdataset/v1/1e-4/checkpoint-{i}/controlnet"
    })
    PRESET['1e-5'].append({
        'name': f'checkpoint-{i}',
        'path': f"/pure/t1/checkpoints/sd-light-time/20250510_webdataset_support/controlnet/shading_webdataset/v1/1e-5/checkpoint-{i}/controlnet"
    })
    
for i in range(250000, 0, -5000):
    PRESET['1e-4_normalize32'].append({
        'name': f'checkpoint-{i}',
        'path': f"/pure/t1/checkpoints/sd-light-time/20250510_webdataset_support/controlnet/shading_webdataset_maxshading32/v1/1e-4/checkpoint-{i}/controlnet"
    })
    PRESET['1e-5_normalize32'].append({
        'name': f'checkpoint-{i}',
        'path': f"/pure/t1/checkpoints/sd-light-time/20250510_webdataset_support/controlnet/shading_webdataset_maxshading32/v1/1e-5/checkpoint-{i}/controlnet"
    })
...
def get_builder_from_mode(mode):
    ...
    if mode == "rotate_everett_dining1_least_square":
        return {
            'split': 100,
            'dataset_params': {
    ...
    if mode == "rotate_everett_kitchen2_least_square":
        return {
            'split': 100,
            'dataset_params': {
                'root_dir': "/data/pakkapon/datasets/multi_illumination/spherical/val_rotate_test_scenes",
    ...
    if mode == "rotate_everett_kitchen4_least_square":
        return {
            'split': 100,
            'dataset_params': {
                'root_dir': "/data/pakkapon/datasets/multi_illumination/spherical/val_rotate_test_scenes",
    ...
    if mode == "rotate_everett_kitchen6_least_square":
        return {
            'split': 100,
            'dataset_params': {
                'root_dir': "/data/pakkapon/datasets/multi_illumination/spherical/val_rotate_test_scenes",
            ...
            for meta in checkpoints:
                for seed in seeds:
                    ...
                    for batch in val_dataloader:
                        if preset in ['1e-4_normalize32', '1e-5_normalize32']:
                            batch['source_shading'] = normalize_with_max_shading(batch['source_shading'], 32)
                            for i in range(len(batch['target_shading'])):
                                batch['target_shading'][i] = normalize_with_max_shading(batch['target_shading'][i], 32)
                        init_latent = None
                    ...
                    os.chmod(f"{output_dir}/scores.json", 0o777)
...
if __name__ == '__main__':
    ...
    parser.add_argument("-m", "--mode", type=str, default="everett_kitchen6,everett_kitchen4,everett_kitchen2,everett_dining1")
