...
#SBATCH --job-name=1e-5LeastSQMulti          #            
...
OUTPUT_DIR="/pure/t1/checkpoints/sd-light-time/20250510_webdataset_support/controlnet/multi_illumination_least_square_diffusionlight/v2/${LEARNING_RATE}"
