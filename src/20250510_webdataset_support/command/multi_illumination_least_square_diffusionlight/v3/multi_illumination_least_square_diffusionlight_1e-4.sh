...
#SBATCH --job-name=1e-4LeastSQMulti          #            
...
OUTPUT_DIR="/pure/t1/checkpoints/sd-light-time/20250510_webdataset_support/controlnet/multi_illumination_least_square_diffusionlight/v3/${LEARNING_RATE}"
