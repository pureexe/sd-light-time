...
from sddiffusionface import SDDiffusionFace, ScrathSDDiffusionFace, SDWithoutAdagnDiffusionFace, SDOnlyAdagnDiffusionFace, SDDiffusionFaceNoBg, SDDiffusionFaceNoShading, SDOnlyShading, SDDiffusionFace5ch, SDShadingwithDivAlbedo, SDShadingwithEdge
...
parser.add_argument(
    ...
    '--network_type', 
    type=str,
    choices=['sd','scrath', 'sd_without_adagn', 'sd_only_adagn', 'sd_no_bg', 'sd_no_shading', 'sd_only_shading', 'inpaint', 'inpaint_no_shading', 'sd5ch', 'sd_color_jitter_defareli', 'sd_color_jitter','sd_shading_with_divalbedo','sd_shading_with_edge'],  # Restrict the input to the accepted strings
...
def get_model_class():
    ...
    elif args.network_type == 'sd_shading_with_divalbedo':
        return SDShadingwithDivAlbedo
    elif args.network_type == 'sd_shading_with_edge':
        return SDShadingwithEdge
