...
class SingleAffineDataset(torch.utils.data.Dataset):
    def __init__(self, num_files=1, *args, **kwargs) -> None:
        ...
        self.image = torchvision.io.read_image(MAN_FACE) / 255.0
...
class SingleAffine(L.LightningModule):
    def __init__(self, *args, **kwargs) -> None:
        ...
        # Inject light direction to UNet 
        self.pipe.unet.set_light_direction = set_light_direction

        add_light_block(self.pipe.unet)


        #set_light_direction, add_light_block, get_optimizable_params
        self.pipe.to('cuda')
