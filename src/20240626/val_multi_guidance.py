...
CKPT_PATH = "output/20240614/multi_mlp_fit/lightning_logs/version_3/checkpoints/epoch=000062.ckpt"
...
for guidance_scale in [1,3,5]:
    trainer = L.Trainer(max_epochs =1000, precision=16, check_val_every_n_epoch=1, default_root_dir="output/20240614/multi_fit_val/1e-4/")
