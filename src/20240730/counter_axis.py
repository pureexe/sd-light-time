        ...
        for chk_pt in CHK_PTS:
            for val_dir in VAL_FILES:
                for version_id in range(3):
                    dir_path = f"{DIR_ROOT}/{name}/{lr}/chk{chk_pt}/{val_dir}/lightning_logs/version_{version_id}/"
