...
class AlbedoOptimization(L.LightningModule):
    def __init__(self, num_images=25, image_size = (512,512), lr_albedo=1e-4, lr_shcoeff=1e-4, std_multiplier = 1e-4, cold_start_albedo=0, sh_regularize=1e-4,use_lab = False):
        super().__init__()        
