...
def denoise_step(pipe, hidden_states, latents, timestep, callback_kwargs, noise_pred_text=None):
        ...
        if 'image' in callback_kwargs:
            down_block_res_samples, mid_block_res_sample = controlnet_step(pipe, hidden_states, latents, timestep, callback_kwargs)
...
def get_ddim_latents(pipe, image, text_embbeding, num_inference_steps, generator = None, controlnet_image=None):
