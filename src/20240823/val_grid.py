...
parser.add_argument("-c", "--checkpoint", type=str, default=",".join([str(i) for i in range(12, 13 )]) ) 
...
NAMES = ['env_under_batch2','env_under_batch2','env_norm_batch2','env_norm_batch2','env_under_batch4','env_under_batch4','env_norm_batch4','env_norm_batch4']
LRS = ['1e-4', '1e-5', '1e-4', '1e-5', '1e-4', '1e-5', '1e-4', '1e-5', ]
                ...
                for checkpoint in checkpoints:
                     for guidance_scale in guidance_scales:
                        if checkpoint == 0:
                            ...
                            CKPT_PATH = f"output/20240823/multi_mlp_fit/lightning_logs/version_{version}/checkpoints/epoch={checkpoint:06d}.ckpt"
