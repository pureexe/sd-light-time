...
parser.add_argument("-i", "--version", type=str, default="21")
parser.add_argument("-m", "--mode", type=str, default="overfit1") #unslpash-trainset or multishoe-trainset
