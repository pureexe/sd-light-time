...
def main():
    ...
    train_dataset = UnsplashLiteDataset(split=slice(args.train_begin, args.train_end, 1), root_dir=args.dataset+"/train")
    val_dataset = UnsplashLiteDataset(split=slice(0,1), root_dir=args.dataset+"/train")
