...
parser.add_argument("-m", "--mode", type=str, default="morning_cat") #unslpash-trainset or multishoe-trainset
parser.add_argument("-g", "--guidance_scale", type=str, default="5")
