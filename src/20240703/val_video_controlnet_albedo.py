...
def main():
    ...
    for guidance_scale in [3]:
        trainer = L.Trainer(max_epochs =1000, precision=16, check_val_every_n_epoch=1, default_root_dir=f"output/20240703/val_video_control/vae5000/3e-4/chk179/g{guidance_scale:.2f}")
