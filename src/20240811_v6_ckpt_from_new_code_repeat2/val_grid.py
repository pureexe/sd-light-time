...
parser.add_argument("-m", "--mode", type=str, default="unslpash-trainset") #unslpash-trainset or multishoe-trainset
parser.add_argument("-g", "--guidance_scale", type=str, default="1.0")
parser.add_argument("-c", "--checkpoint", type=str, default=",".join([str(i) for i in range(0,35)]) ) 
...
#LRS = ['1e-5', '5e-5', '1e-5', '5e-4', '1e-4', '5e-5', '1e-5', '5e-4']
NAMES = ['no_consistnacy', 'no_consistnacy', 'no_consistnacy', 'no_consistnacy']
                ...
                for checkpoint in checkpoints:
                     for guidance_scale in guidance_scales:
                        if checkpoint == 0:
                            ...
                            #CKPT_PATH = f"/home/pakkapon/mnt_tl_vision17/pure/tu150/output/sd-light-time/20240815/multi_mlp_fit/lightning_logs/version_{version}/checkpoints/epoch={checkpoint:06d}.ckpt"
                            CKPT_PATH = f"output/20240815/multi_mlp_fit/lightning_logs/version_{version}/checkpoints/epoch={checkpoint:06d}.ckpt"
