...
@notify
def main():
    model = AffineConsistancy(learning_rate=args.learning_rate,envmap_embedder=args.envmap_embedder, use_consistancy_loss = (args.use_consistancy_loss==1), gate_multipiler=args.gate_multipiler)
