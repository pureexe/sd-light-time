...
# 1e-4RANK 4 accumulation 4
accelerate launch train_dreambooth_lora_sd3.py \
  --pretrained_model_name_or_path="stabilityai/stable-diffusion-3.5-medium"  \
  --output_dir="../../output/20241125_dreambooth_face/right_321_acc/lr1e-4_rank4_acc4" \
  --dataset_name="/ist/ist-share/vision/relight/datasets/face/simple_face_lora/face_right_321" \
  --instance_prompt=", with sunlight illuminate on the sks" \
  --caption_column=caption \
  --resolution=1024 \
...
# 1e-4RANK 4 accumulation 8
accelerate launch train_dreambooth_lora_sd3.py \
  --pretrained_model_name_or_path="stabilityai/stable-diffusion-3.5-medium"  \
  --output_dir="../../output/20241125_dreambooth_face/right_321_acc/lr1e-4_rank4_acc8" \
  --dataset_name="/ist/ist-share/vision/relight/datasets/face/simple_face_lora/face_right_321" \
  --instance_prompt=", with sunlight illuminate on the sks" \
  --caption_column=caption \
  --resolution=1024 \
...
# 1e-4RANK 4 accumulation 16
accelerate launch train_dreambooth_lora_sd3.py \
  --pretrained_model_name_or_path="stabilityai/stable-diffusion-3.5-medium"  \
  --output_dir="../../output/20241125_dreambooth_face/right_321_acc/lr1e-4_rank4_acc16" \
  --dataset_name="/ist/ist-share/vision/relight/datasets/face/simple_face_lora/face_right_321" \
  --instance_prompt=", with sunlight illuminate on the sks" \
  --caption_column=caption \
  --resolution=1024 \
...
# 1e-4RANK 4 accumulation 32
accelerate launch train_dreambooth_lora_sd3.py \
  --pretrained_model_name_or_path="stabilityai/stable-diffusion-3.5-medium"  \
  --output_dir="../../output/20241125_dreambooth_face/right_321_acc/lr1e-4_rank4_acc32" \
  --dataset_name="/ist/ist-share/vision/relight/datasets/face/simple_face_lora/face_right_321" \
  --instance_prompt=", with sunlight illuminate on the sks" \
  --caption_column=caption \
  --resolution=1024 \
...
# 1e-4RANK 16 accumulation 4
accelerate launch train_dreambooth_lora_sd3.py \
  --pretrained_model_name_or_path="stabilityai/stable-diffusion-3.5-medium"  \
  --output_dir="../../output/20241125_dreambooth_face/right_321_acc/lr1e-4_rank16_acc4" \
  --dataset_name="/ist/ist-share/vision/relight/datasets/face/simple_face_lora/face_right_321" \
  --instance_prompt=", with sunlight illuminate on the sks" \
  --caption_column=caption \
  --resolution=1024 \
...
# 1e-4RANK 16 accumulation 8
accelerate launch train_dreambooth_lora_sd3.py \
  --pretrained_model_name_or_path="stabilityai/stable-diffusion-3.5-medium"  \
  --output_dir="../../output/20241125_dreambooth_face/right_321_acc/lr1e-4_rank16_acc8" \
  --dataset_name="/ist/ist-share/vision/relight/datasets/face/simple_face_lora/face_right_321" \
  --instance_prompt=", with sunlight illuminate on the sks" \
  --caption_column=caption \
  --resolution=1024 \
...
# 1e-4RANK 16 accumulation 16
accelerate launch train_dreambooth_lora_sd3.py \
  --pretrained_model_name_or_path="stabilityai/stable-diffusion-3.5-medium"  \
  --output_dir="../../output/20241125_dreambooth_face/right_321_acc/lr1e-4_rank16_acc16" \
  --dataset_name="/ist/ist-share/vision/relight/datasets/face/simple_face_lora/face_right_321" \
  --instance_prompt=", with sunlight illuminate on the sks" \
  --caption_column=caption \
  --resolution=1024 \
...
# 1e-4RANK 16 accumulation 32
accelerate launch train_dreambooth_lora_sd3.py \
  --pretrained_model_name_or_path="stabilityai/stable-diffusion-3.5-medium"  \
  --output_dir="../../output/20241125_dreambooth_face/right_321_acc/lr1e-4_rank16_acc32" \
  --dataset_name="/ist/ist-share/vision/relight/datasets/face/simple_face_lora/face_right_321" \
  --instance_prompt=", with sunlight illuminate on the sks" \
  --caption_column=caption \
  --resolution=1024 \
