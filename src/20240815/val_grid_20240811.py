...
parser.add_argument("-i", "--version", type=str, default="7")
...
#parser.add_argument("-c", "--checkpoint", type=str, default='0,1,2,3,4,5,10,15,20,25,30,35,40')
#parser.add_argument("-c", "--checkpoint", type=str, default='0,1,2,3')
#parser.add_argument("-c", "--checkpoint", type=str, default='3,4,5,10')
#parser.add_argument("-c", "--checkpoint", type=str, default='15,20,25')
parser.add_argument("-c", "--checkpoint", type=str, default='30,35,40')
...
LRS = ['5e-4', '1e-4', '5e-5', '1e-5', '1e-3', '5e-5', '1e-5', '5e-4', '1e-4','1e-4', '1e-4','1e-4', '1e-4','1e-4', '1e-4','1e-4', '1e-4']
                ...
                for checkpoint in checkpoints:
                     for guidance_scale in guidance_scales:
                        ...
                        if checkpoint == 0:
                            ...
                            CKPT_PATH = f"/home/pakkapon/mnt_tl_vision17/pure/tu150/output/sd-light-time/20240811/multi_mlp_fit/lightning_logs/version_{version}/checkpoints/epoch={checkpoint:06d}.ckpt"
                        ...
                        print("================================")
                        trainer = L.Trainer(max_epochs=1000, precision=16, check_val_every_n_epoch=1, default_root_dir=f"output/{FOLDER_NAME}/val_{mode}_20240811/{guidance_scale}/{NAMES[version]}/{LRS[version]}/chk{checkpoint}/")
