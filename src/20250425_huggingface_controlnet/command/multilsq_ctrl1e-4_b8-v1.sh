...
#SBATCH --job-name=1e-4b8v1multilsq          # Job name: 1e-4 no clip face 111155 / 111295 
...
OUTPUT_DIR="/ist/ist-share/vision/pakkapon/relight/sd-light-time/output/20250425_huggingface_controlnet/controlnet/MultiLstShading/v1/learning_rate_${LEARNING_RATE}/batch_${BATCH_NAME}_v1"
