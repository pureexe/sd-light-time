...
#SBATCH --job-name=5e-6_v4_shading          #           V1_OLD: 111180 
...
OUTPUT_DIR="/pure/t1/checkpoints/sd-light-time/20250425_huggingface_controlnet/controlnet/shading_v4/v1/${LEARNING_RATE}"
