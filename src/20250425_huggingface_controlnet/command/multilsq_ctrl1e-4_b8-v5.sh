...
#SBATCH --job-name=1e-4b8v5multilsq          # Job name: 1e-4 no clip face 111294 
...
OUTPUT_DIR="/pure/t1/checkpoints/sd-light-time/20250425_huggingface_controlnet/controlnet/MultiLstShading/v1/learning_rate_${LEARNING_RATE}/batch_${BATCH_NAME}_v5"
