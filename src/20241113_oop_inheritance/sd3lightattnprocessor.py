    ...
    def __call__(
        ...
        **kwargs,
        ...
        if light_hidden_states is not None:
            ...
            light_hidden_states_key_proj = attn.light_q_proj(light_hidden_states)
            light_hidden_states_value_proj = attn.light_q_proj(light_hidden_states)
        ...
        if light_hidden_states is not None:
            # Split the light out from attention output
        ...
        if encoder_hidden_states is not None and light_hidden_states is not None:
