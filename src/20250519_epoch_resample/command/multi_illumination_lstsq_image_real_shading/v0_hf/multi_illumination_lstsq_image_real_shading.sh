#!/bin/bash
#SBATCH --error=output/logs/error/%j_lstimgrealshading_err.txt   # STDOUT error is written in slurm.out.JOBID
#SBATCH --output=output/logs/output/%j_lstimgrealshading_out.txt  # STDOUT output is written in slurm.err.JOBID
#SBATCH --job-name=lstimgrealshading          #            
...
OUTPUT_DIR="/pure/t1/checkpoints/sd-light-time/20250519_epoch_resample/controlnet/multi_illumination_lstsq_image_real_shading/v0_hf/${LEARNING_RATE}"
DATASET_PATH="/pure/f1/datasets/multi_illumination/lstsq_image_real_shading/v0/hf/MultiLstsqImageRealShading/MultiLstsqImageRealShading.py"
