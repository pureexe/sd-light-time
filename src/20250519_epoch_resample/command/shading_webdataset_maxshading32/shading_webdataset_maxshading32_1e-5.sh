...
#SBATCH --job-name=1e-5n32web4_shading          #           
...
# RUN ON   115263/115181/114928/113153
...
OUTPUT_DIR="/pure/t1/checkpoints/sd-light-time/20250510_webdataset_support/controlnet/shading_webdataset_maxshading${MAX_SHADING}/v1/${LEARNING_RATE}"
