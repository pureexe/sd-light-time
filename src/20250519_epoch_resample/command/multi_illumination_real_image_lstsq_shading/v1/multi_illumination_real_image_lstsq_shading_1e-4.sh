...
OUTPUT_DIR="/pure/t1/checkpoints/sd-light-time/20250519_epoch_resample/controlnet/multi_illumination_real_image_lstsq_shading/v1/${LEARNING_RATE}"
TRAIN_DATA_DIR="/pure/f1/datasets/multi_illumination/real_image_lstsq_shading/v1/train/train-{0000..024}.tar"
