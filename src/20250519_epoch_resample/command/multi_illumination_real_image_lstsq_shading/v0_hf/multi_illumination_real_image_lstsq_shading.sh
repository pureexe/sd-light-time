#!/bin/bash
#SBATCH --error=output/logs/error/%j_realimglstshading_err.txt   # STDOUT error is written in slurm.out.JOBID
#SBATCH --output=output/logs/output/%j_realimglstshading_out.txt  # STDOUT output is written in slurm.err.JOBID
#SBATCH --job-name=realimglstshading          #            
...
OUTPUT_DIR="/pure/t1/checkpoints/sd-light-time/20250519_epoch_resample/controlnet/multi_illumination_real_image_lstsq_shading/v0_hf/${LEARNING_RATE}"
DATASET_PATH="/pure/f1/datasets/multi_illumination/real_image_lstsq_shading/v0/hf/MultiRealImageLstsqShading/MultiRealImageLstsqShading.py"
