...
COMMAND="python inference.py -p 1e-5_normalize32 -m rotate_everett_kitchen2"

echo ${COMMAND}

CUDA_VISIBLE_DEVICES=0 singularity exec --bind /pure:/pure --bind /ist:/ist --nv --env HF_HUB_CACHE=/ist/ist-share/vision/huggingface/hub/ --env HUB_HOME=/ist/ist-share/vision/huggingface/ ${CONTAINER} ${COMMAND}
