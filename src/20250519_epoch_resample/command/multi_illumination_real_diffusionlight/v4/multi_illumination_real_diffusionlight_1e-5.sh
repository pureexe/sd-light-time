...
#SBATCH --job-name=v41e-5RealMulti         #            
...
OUTPUT_DIR="/pure/t1/checkpoints/sd-light-time/20250510_webdataset_support/controlnet/multi_illumination_real_diffusionlight/v4/${LEARNING_RATE}"
TRAIN_DATA_DIR="/pure/f1/datasets/multi_illumination/real/v4_webdataset/train/train-{0000..024}.tar"
