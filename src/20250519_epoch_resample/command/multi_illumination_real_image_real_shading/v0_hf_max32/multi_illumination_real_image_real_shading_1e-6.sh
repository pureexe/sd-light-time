#!/bin/bash
#SBATCH --error=output/logs/error/%j_inspect32_err.txt   # STDOUT error is written in slurm.out.JOBID
#SBATCH --output=output/logs/output/%j_inspect32_out.txt  # STDOUT output is written in slurm.err.JOBID
#SBATCH --job-name=1e-6max32realreal          #            
