#!/bin/bash
#SBATCH --error=output/logs/output/%j_1e-5_shadings150k_maxshading32_out.txt   # STDOUT output is written in slurm.out.JOBID
#SBATCH --output=output/logs/error/%j_1e-5_shadings150k_maxshading32_err.txt  # STDOUT error is written in slurm.err.JOBID
#SBATCH --job-name=1e-5_shadings150k_maxshading32          #           V1_OLD: 111180 
