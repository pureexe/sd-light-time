...
#SBATCH --job-name=1e-4web4_shading          #            
...
# RUN ON  115261/115178/114975/113076 
...
OUTPUT_DIR="/pure/t1/checkpoints/sd-light-time/20250510_webdataset_support/controlnet/shading_webdataset/v1/${LEARNING_RATE}"
