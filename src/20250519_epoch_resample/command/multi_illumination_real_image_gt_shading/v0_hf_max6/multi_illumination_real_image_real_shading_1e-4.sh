#!/bin/bash
#SBATCH --error=output/logs/error/%j_1e-4max6_realgt_err.txt   # STDOUT error is written in slurm.out.JOBID
#SBATCH --output=output/logs/output/%j_1e-4max6_realgt_out.txt  # STDOUT output is written in slurm.err.JOBID
#SBATCH --job-name=1e-4max6realgt         #            
...
DATASET_PATH="/pure/f1/datasets/multi_illumination/real_image_gt_shading/v0/hf/MultiRealImageGtShading/MultiRealImageGtShading.py"
