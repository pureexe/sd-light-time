...
#SBATCH --job-name=1e-4_optimized_shading          # 111763/111628
...
COMMAND="python src/20250419_train_in_the_wild/train.py -lr ${LEARNING_RATE} --guidance_scale 1.0 --network_type ${NETWORK_TYPE} --batch_size 8 -c 5 --feature_type clip --shadings_dir control_shading_from_fitting_v3_exr --backgrounds_dir control_render_from_fitting_v2 --images_dir control_render_from_fitting_v2 -dataset /data/pakkapon/datasets/multi_illumination/spherical/train -dataset_split /data/pakkapon/datasets/multi_illumination/spherical/index/multi_train.json -dataset_val /data/pakkapon/datasets/multi_illumination/spherical/train -dataset_val_split /data/pakkapon/datasets/multi_illumination/spherical/index/14n_copyroom10_test.json -ckpt /ist/ist-share/vision/pakkapon/relight/sd-light-time/output/20250419_train_in_the_wild/storage_t1/lightning_logs/version_111628/checkpoints/epoch=000004.ckpt"
