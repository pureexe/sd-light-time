...
#SBATCH --job-name=1e-4ncm3          # Job name: 1e-4 no clip multi-ilumn #111780/111416/111018  
...
COMMAND="python src/20250419_train_in_the_wild/train.py -lr ${LEARNING_RATE} --guidance_scale 1.0 --network_type ${NETWORK_TYPE} --batch_size 8 -c 5 --feature_type clip --shadings_dir control_shading_from_fitting_v3_exr --backgrounds_dir control_render_from_fitting_v2 --images_dir control_render_from_fitting_v2 -dataset /data/pakkapon/datasets/multi_illumination/spherical/train  -dataset_val /data/pakkapon/datasets/multi_illumination/spherical/val -dataset_val_split /data/pakkapon/datasets/multi_illumination/spherical/split-val-relight-light-array.json  --seed 300 -ckpt /ist/ist-share/vision/pakkapon/relight/sd-light-time/output/20250419_train_in_the_wild/multi_mlp_fit/lightning_logs/version_111416/checkpoints/epoch=000094.ckpt"
