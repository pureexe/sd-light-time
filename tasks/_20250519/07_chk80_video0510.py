...
EXPERIMENT = ['multi_illumination_real_diffusionlight_1e-4', 'multi_illumination_real_diffusionlight_1e-5','multi_illumination_least_square_diffusionlight_1e-4','multi_illumination_least_square_diffusionlight_1e-5']
CHECKPOINTS = [80]
for scene in SCENES:
    for experiment in EXPERIMENT:
        for checkpoint in CHECKPOINTS:
            predict_path = f"/ist/ist-share/vision/pakkapon/relight/sd-light-time/output/20250510_huggingface_controlnet/val_rotate_{scene}/{experiment}/chk{checkpoint}/seed42"
            print(predict_path)
