...
EXPERIMENT = ["multi_illumination_real_image_lstsq_shading_v0_hf", "multi_illumination_vary_scene_985"]
CHECKPOINTS = [80, 70]
...
for scene in SCENES:
    for experiment in EXPERIMENT:
        for checkpoint in CHECKPOINTS:
            predict_path = f"/ist/ist-share/vision/pakkapon/relight/sd-light-time/output_t1/20250519_epoch_resample/val_rotate_{scene}_least_square_shading/{experiment}/chk{checkpoint}/seed42"
            print(predict_path)
            video_dir = os.path.join(f'/ist/ist-share/vision/pakkapon/relight/sd-light-time/output_t1/20250519_epoch_resample/val_rotate_{scene}_least_square_shading', "video")
